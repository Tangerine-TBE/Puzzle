package com.weilai.jigsawpuzzle.ad;
...
public class UserBean {
    ...
    public class Data {
        ...
        private int smallcashpublic;
        private int chargeold;
        private int virginid;
        private int videopricepublic;
        private int viewpublic;
        ...
        public int getSmallcashpublic() {
            return smallcashpublic;
        }

        public void setSmallcashpublic(int smallcashpublic) {
            this.smallcashpublic = smallcashpublic;
        }
        ...
        public int getVideopricepublic() {
            return videopricepublic;
        }

        public void setVideopricepublic(int videopricepublic) {
            this.videopricepublic = videopricepublic;
        }

        public int getViewpublic() {
            return viewpublic;
        }

        public void setViewpublic(int viewpublic) {
