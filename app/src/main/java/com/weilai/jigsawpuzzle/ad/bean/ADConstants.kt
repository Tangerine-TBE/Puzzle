...
object ADConstants {
    ...
    val kWaiAppKey by lazy { SPUtil.getInstance().getString("kWaiAppKey","887200007")?:"887200007" }
    val kWaiChaPingKey by lazy { SPUtil.getInstance().getString("kWaiChaPingKey","8872000020")?:"8872000020" }
    val kWaiKaiPingKey by lazy { SPUtil.getInstance().getString("kWaiKaiPingKey","8872000033")?:"8872000033" }
    val kWaiNativeKey by lazy { SPUtil.getInstance().getString("kWaiNativeKey","8872000034")?:"8872000034" }
    val kWaiJiLiKey by lazy { SPUtil.getInstance().getString("kWaiJiLiKey","8872000016")?:"8872000016" }
}