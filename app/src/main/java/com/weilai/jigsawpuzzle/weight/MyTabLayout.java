...
//setter and getter
    ...
    private MyTabLayout.IndicatorPoint mCurrentP = new MyTabLayout.IndicatorPoint();
    private MyTabLayout.IndicatorPoint mLastP = new MyTabLayout.IndicatorPoint();

    class PointEvaluator implements TypeEvaluator<MyTabLayout.IndicatorPoint> {
        @Override
        public MyTabLayout.IndicatorPoint evaluate(float fraction, MyTabLayout.IndicatorPoint startValue, MyTabLayout.IndicatorPoint endValue) {
            float left = startValue.left + fraction * (endValue.left - startValue.left);
            float right = startValue.right + fraction * (endValue.right - startValue.right);
            MyTabLayout.IndicatorPoint point = new MyTabLayout.IndicatorPoint();
            point.left = left;
            point.right = right;
            return point;
        }
