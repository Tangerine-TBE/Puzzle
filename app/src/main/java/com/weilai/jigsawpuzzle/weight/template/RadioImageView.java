...
public class RadioImageView extends AppCompatImageView {
    ...
    public RadioImageView(@NonNull Context context) {
        this(context,null);
    }

    public RadioImageView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public RadioImageView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
