...
//        spannableString.setSpan(styleSpan3, 6, 9, Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
    ...
    private void body(TextView view){
        ...
        fuwu.setSpan(new ForegroundColorSpan(Color.parseColor("#5B92FF")),0,fuwu.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        yinsi.setSpan(new ForegroundColorSpan(Color.parseColor("#5B92FF")),0,yinsi.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
