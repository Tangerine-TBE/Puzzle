 ...
 * * Description:
 **/
public class PortraitTextColorAdapter extends RecyclerView.Adapter<PortraitTextColorAdapter.ViewHolder> {
    ...
    public PortraitTextColorAdapter(List<Integer> list,OnItemClickedListener onItemClickedListener) {
        this.list = list;
